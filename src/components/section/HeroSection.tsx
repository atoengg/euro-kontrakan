                ...
                <div className="container mx-auto">
                    <div className={`${styles.wrapper__hero} w-full flex justify-between pt-24 lg:pt-32 flex-row items-center`}>
                        <div className={` ${styles.hero} w-5/12 flex flex-col`}>
                            ...
                            <p className="text-[12px] lg:text-sm text-[#1d3e5d] font-semibold my-3">Cari momen kenanganmu bersama Euro kontrakan</p>
                        ...
                        <div className={`${styles.hero__img} grid grid-cols-1 lg:grid-cols-3 gap-3 w-6/12`}>
                            <div className={`${styles.wrapper__img} lg:relative`}>
                                <img
                                    src={galeriTest1.src}
                                    alt=""
